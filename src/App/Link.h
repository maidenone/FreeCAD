...
#define LINK_PARAMS_ELEMENT \
    (LINK_PARAM_OBJECT(LinkedObject, App::PropertyXLink,\
        App::PropertyType(App::Prop_Transient|App::Prop_Hidden|App::Prop_ReadOnly), " Link"))\
    LINK_PARAM_EXT(SCALE)\
    LINK_PARAM_EXT_ATYPE(TRANSFORM,App::PropertyType(App::Prop_ReadOnly|App::Prop_Hidden)) \
    LINK_PARAM_EXT(LINK_PLACEMENT)\
    LINK_PARAM_EXT_ATYPE(PLACEMENT,App::PropertyType(App::Prop_Transient)) 
