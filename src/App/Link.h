...
#define LINK_PARAM_SUB(...) \
    (SubName, std::string, App::PropertyString, (""), "To reference a sub object inside the linked object", ##__VA_ARGS__)
...
#define LINK_PROP_GET(_1,_2,_param) \
    ...
    void setLink(DocumentObject *obj, const char *subname=0,
...
public:
    ...
    App::DocumentObject *getSubObject(const char *subname, PyObject **pyObj=0, 
            Base::Matrix4D *mat=0, bool transform=true, int depth=0) const override;

    App::DocumentObject *getLinkedObject(
        bool recurse, Base::Matrix4D *mat=0, bool transform=true, int depth=0) const override;
