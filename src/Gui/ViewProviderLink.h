...
public:
    virtual void unlink() {}
    virtual void onLinkedIconChange() {}
...
class GuiExport LinkHandle : public Base::BaseClass, public LinkOwner {
    TYPESYSTEM_HEADER();
public:
    ...
    void setSize(int size, bool reset = false);
...
protected:
    ...
    bool hasSubName(const App::LinkBaseExtension *ext = 0) const;
